...
const messages = defineMessages({
  ...
  users4k:
    '<strong>{userCount, number} {userCount, plural, one {user} other {users}}</strong> {userCount, plural, one {has} other {have}} played this {mediaType} in 4K {playCount, number} {playCount, plural, one {time} other {times}}:',
  movie: 'movie',
  tvshow: 'series',
});
